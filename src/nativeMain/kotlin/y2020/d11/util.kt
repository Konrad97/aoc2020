...
fun Int.printResult() = println("The result is $this")

val preparedInput: List<List<Pair<Boolean, Boolean>>> by lazy {
    input.lines().map { line -> line.map { (it == 'L') to false } }
}

private const val input = """LLLLLLLLLLL.LLLLLLLLLLLL.LLLLL.LLLLLLLLLLLLL.LLLLLLLLL.LLL.LLLLLLLLLL.LLLLLLL.LLLLLLLLLLLLLLLLLLL
